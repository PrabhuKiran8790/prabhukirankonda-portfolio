import { k as derived, w as writable, r as readable, l as readonly } from "./exports.js";
import { w as set_current_component, x as run_all, y as current_component, c as create_ssr_component, g as add_attribute, l as compute_rest_props, b as spread, d as escape_object, p as escape_attribute_value, i as each, v as validate_component, o as onDestroy, j as get_store_value, s as setContext, k as getContext } from "./ssr.js";
...
const { name: name$4, selector } = createElHelpers("accordion");
const defaults$8 = {
  multiple: false,
  disabled: false,
  forceVisible: false
...
const createAccordion = (props) => {
  ...
  const item = builder(name$4("item"), {
    stores: value,
    returned: ($value) => {
      return (props2) => {
  ...
  const trigger = builder(name$4("trigger"), {
  ...
  const content = builder(name$4("content"), {
  ...
  const heading = builder(name$4("heading"), {
    returned: () => {
      return (props2) => {
...
const createAvatar = (props) => {
  ...
  const image = builder("avatar-image", {
    ...
    returned: ([$src, $loadingStatus]) => {
      const imageStyles = styleToString$1({
  ...
  const fallback = builder("avatar-fallback", {
    ...
    returned: ([$loadingStatus]) => {
      return {
        style: $loadingStatus === "loaded" ? styleToString$1({
          display: "none"
        }) : void 0,
...
function createDialog(props) {
  ...
  const overlay = builder(name$3("overlay"), {
    stores: [isVisible],
    returned: ([$isVisible]) => {
      return {
        hidden: $isVisible ? void 0 : true,
  ...
  const portalled = builder(name$3("portalled"), {
    stores: portal,
    returned: ($portal) => ({
      "data-portal": $portal ? "" : void 0
    }),
  ...
  const title = builder(name$3("title"), {
    stores: [ids.title],
    returned: ([$titleId]) => ({
      id: $titleId
    })
  });
  const description = builder(name$3("description"), {
    stores: [ids.description],
    returned: ([$descriptionId]) => ({
      id: $descriptionId
    })
  });
  const close = builder(name$3("close"), {
    returned: () => ({
      type: "button"
    }),
    action: (node) => {
...
function createLinkPreview(props = {}) {
  ...
  const arrow2 = builder(name$2("arrow"), {
    stores: arrowSize,
    returned: ($arrowSize) => ({
      "data-arrow": true,
      style: styleToString$1({
...
const getAttrs$8 = createBitAttrs(NAME$l, PARTS$l);
function setCtx$7(props) {
...
const getAttrs$7 = createBitAttrs(NAME$j, PARTS$j);
function setCtx$6(props) {
  const avatar = createAvatar(removeUndefined(props));
  setContext(NAME$j, avatar);
  return {
    ...avatar,
...
function getImage(src = "") {
  const avatar = getContext(NAME$j);
  if (!src) {
...
const getAttrs$5 = createBitAttrs(NAME$f, PARTS$f);
...
const getAttrs$4 = createBitAttrs(NAME$e, PARTS$e);
function getCtx$3() {
...
const getAttrs$3 = createBitAttrs(NAME$d, PARTS$d);
function getCtx$2() {
  return getContext(NAME$d);
}
...
const PARTS$6 = ["root"];
const getAttrs$1 = createBitAttrs(NAME$6, PARTS$6);
